...
const Form = ( {type, register, handleSubmit, handleImageChange, formLoading, onFinishHandler, announcementImage} : FormProps )  => {
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        <FormControl>
          <FormHelperText sx={{fontWeight: 500, margin: '10px', fontSize: 16, color:'#11142d'}}>Enter Announcement Subject</FormHelperText>
            <TextField
              fullWidth
              required
              id="outlined-basic"
        ...
        <Stack direction="column" gap={1} justifyContent="center" mb={2}>
          <Stack direction="row" gap={2}>
            <Typography color="#11142d" fontSize={16} fontWeight={500}my="10px"> Announcement Image (required)</Typography>
          ...
          <Typography fontSize={14} color="#808191" sx={{wordBreak: 'break-all'}}>{announcementImage?.name}</Typography>
        </Stack>
